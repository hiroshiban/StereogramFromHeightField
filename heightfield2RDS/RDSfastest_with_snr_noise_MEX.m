function [imgL,imgR]=RDSfastest_with_snr_noise_MEX(posL,posR,wdot,bdot,dotalpha,dotDens,bgcolor)

% Generates left/right Random-Dot-AntiCorrelated-Stereogram images with noise (MEX-based).
% function [imgL,imgR]=RDSfastest_with_snr_noise(posL,posR,wdot,bdot,dotalpha,dotDens,noise_params,bgcolor)
%
...
% Last Update: "2017-09-26 10:29:16 ban"
...
imgL=uint8(ReplaceDots2Ovals(imgLids,idxL,0,wdot,bdot,dotalpha,bgcolor,1)); % MEX function
imgR=uint8(ReplaceDots2Ovals(imgRids,idxR,0,wdot,bdot,dotalpha,bgcolor,0)); % MEX function
